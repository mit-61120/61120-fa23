#!/bin/bash
# >>> ./run-tests.sh ../../reference/vm/compiler ../../reference/vm/interpreter ./compiler ./interpreter out.txt
...
run_both_tests $COMPILER $REF a2 public
echo "Passed $COUNT out of $TOTAL tests when testing their compiler with reference interpreter on a2 public" >> $RESULTS
echo "Passed $COUNT out of $TOTAL tests when testing their compiler with reference interpreter on a2 public"
run_both_tests $REFC $INTERPRETER a2 public
echo "Passed $COUNT out of $TOTAL tests when testing reference compiler with their interpreter on a2 public" >> $RESULTS
echo "Passed $COUNT out of $TOTAL tests when testing reference compiler with their interpreter on a2 public"
...
run_both_tests $COMPILER $REF a2 private
echo "Passed $COUNT out of $TOTAL tests when testing their compiler with reference interpreter on a2 private" >> $RESULTS
echo "Passed $COUNT out of $TOTAL tests when testing their compiler with reference interpreter on a2 private"
run_both_tests $REFC $INTERPRETER a2 private
echo "Passed $COUNT out of $TOTAL tests when testing reference compiler with their interpreter on a2 private" >> $RESULTS
echo "Passed $COUNT out of $TOTAL tests when testing reference compiler with their interpreter on a2 private"
...
run_both_tests $COMPILER $REF a3 public/mit
echo "Passed $COUNT out of $TOTAL tests when testing their compiler with reference interpreter on a3 public" >> $RESULTS
echo "Passed $COUNT out of $TOTAL tests when testing their compiler with reference interpreter on a3 public"
run_both_tests $REFC $INTERPRETER a3 public/mit
echo "Passed $COUNT out of $TOTAL tests when testing reference compiler with their interpreter on a3 public" >> $RESULTS
echo "Passed $COUNT out of $TOTAL tests when testing reference compiler with their interpreter on a3 public"
...
run_both_tests $COMPILER $REF a3 private
echo "Passed $COUNT out of $TOTAL tests when testing their compiler with reference interpreter on a3 private" >> $RESULTS
echo "Passed $COUNT out of $TOTAL tests when testing their compiler with reference interpreter on a3 private"
run_both_tests $REFC $INTERPRETER a3 private
echo "Passed $COUNT out of $TOTAL tests when testing reference compiler with their interpreter on a3 private" >> $RESULTS
echo "Passed $COUNT out of $TOTAL tests when testing reference compiler with their interpreter on a3 private"
